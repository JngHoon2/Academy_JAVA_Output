...
public class MethodClass {
	...
	public static String makeTagsQ8(ResultSet rs, String[] fieldNames) {
		...
		try {
			...
			while (rs.next()) {
				...
				makeTags = makeTags + "<td>" + rs.getString(2) + "</td>";
				makeTags = makeTags + "<td>" + rs.getString(3) + "</td>";
				makeTags = makeTags + "<td>" + rs.getString(4) + "</td>";
				makeTags = makeTags + "</tr>";
			}
	...
	public static String makeTagsQ9(ResultSet rs, String[] fieldNames) {
		...
		try {
			...
			while (rs.next()) {
				...
				makeTags = makeTags + "<td>" + rs.getString(3) + "</td>";
				makeTags = makeTags + "<td>" + rs.getString(4) + "</td>";
				makeTags = makeTags + "<td>" + rs.getString(5) + "</td>";
				makeTags = makeTags + "</tr>";
			}
	...
	public static String makeTagsQ10(ResultSet rs, String[] fieldNames) {
		String makeTags = "";
	...
	public static String makeTagsQ11(ResultSet rs, String[] fieldNames) {
		String makeTags = "";
