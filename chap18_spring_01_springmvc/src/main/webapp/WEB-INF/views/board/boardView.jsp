...
<body>
	...
	<div>
		...
		<p class="btn_align">
			...
			<input type="button" value="수정" onclick="goUrl('<c:url value="/boardModify.do?no=${board.no}" />');" />
			<input type="button" value="삭제" onclick="deleteCheck('<c:url value="/boardDelete.do?no=${board.no}" />');" />
			<input type="button" value="답글쓰기" onclick="goUrl('<c:url value="/boardReplyWrite.do?no=${board.no}" />');" />
		</p>
	</div>	
</body>
</html>