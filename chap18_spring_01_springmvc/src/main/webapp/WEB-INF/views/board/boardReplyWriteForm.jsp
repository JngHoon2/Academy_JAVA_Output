...
<body>
	...
	<div>
		<form name="replyWriteForm"
			...
			<input type="hidden" name="reply_ref" value="<c:out value="${board.reply_ref}" />" />
			<input type="hidden" name="reply_lev" value="<c:out value="${board.reply_lev}" />" />
			<input type="hidden" name="reply_seq" value="<c:out value="${board.reply_seq}" />" />
			<div>				
