...
<body>
	...
	<c:if test="${empty id}">
		<div id="wrap" align="center">
			<h1>관리자 로그인</h1>
			<form method="post" action="${contextPath}/workerLogin.do" name="login_form">
				<div>
					아이디 <input type="text"  placeholder="아이디" name="id" maxlength="20" value="a" required  />
		    	</div>
		   		<div>
					비밀번호 <input type="password"  placeholder="비밀번호" name="pwd" maxlength="20" value="1" required />
		    	</div>
