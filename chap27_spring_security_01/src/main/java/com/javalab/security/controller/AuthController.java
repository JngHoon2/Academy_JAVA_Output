package com.javalab.security.controller;
...
import com.javalab.security.service.AuthJdbcService;
import com.javalab.security.service.AuthMyBatisService;
...
public class AuthController {
	...
	// security-context.xml에서 설정해놓은 빈을 주입함.
	@Autowired
	...
	// 반환형이 void 이면 url이 화면명으로 리턴됨 즉, url.jsp가 최종 보여질 화면이 됨.
	...
	public String join(@RequestParam("username") String username,
		...
		Users users = new Users(username,
								hashedPassword,
								1);	// 기본으로 사용함, 즉 enabled
		
		log.info("AuthController > join 메소드 : " + users.toString());
