	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<sec:authorize access="isAuthenticated()">
	   			<ul class="nav navbar-nav navbar-right">
					<li><a href="${pageContext.request.contextPath}/user/member_update?user_id=<sec:authentication property="principal.username"/>">(<sec:authentication property="principal.username"/>)님 정보변경(미구현)</a></li>
