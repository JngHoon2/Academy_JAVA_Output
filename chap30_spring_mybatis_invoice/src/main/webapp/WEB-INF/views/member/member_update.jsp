...
<%@ include file="/WEB-INF/views/shared/header.jsp" %>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="${pageContext.request.contextPath}/user/member_update" name="updateForm">
				<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" /> 
				<input type="hidden" name="user_id" value="${map.customUser.user_id}" />
				<table class="table table-bordered table-hover table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							...
							<td colspan="2"><input type="text" class="form-control" name="user_name" maxlength="50" value="${map.customUser.user_name}"></td>
						</tr>
						<tr>
							<td style="width: 20%">비밀번호</td>
							<td colspan="2"><input type="text" class="form-control" name="user_pwd" maxlength="50" value="${map.customUser.user_pwd}"></td>
						</tr>
						<tr>
							<td style="width: 20%">이메일</td>
							<td colspan="2"><input type="text" class="form-control" name="email" maxlength="50" value="${map.customUser.email}"></td>
						</tr>
						<tr>
							<td>전화번호</td>
							<td colspan="2"><input type="text" class="form-control"  name="phone" maxlength="100" value="${map.customUser.phone}"></td>
						</tr>
						<tr>
							<td>주소</td>
							<td colspan="2"><input type="text" class="form-control"  name="address1" maxlength="100" value="${map.customUser.address1}"></td>
						</tr>
						<tr>
							<td>부서</td>
							<td colspan="2"><input type="text" class="form-control"  name="dept_id" maxlength="100" value="${map.customUser.dept_id}"></td>
						</tr>
						<tr>
							<td>권한</td>
							<td colspan="2"><input type="text" class="form-control"  name=role_id maxlength="100" value="${map.customUser.role_id}"></td>
						</tr>
					</tbody>
				</table>
				<div align="center">
