...
public class MemberMain {
	...
	public static void main(String[] args) {
		...
		Member[] mem = new Member[98];

		for (int i = 0; i < 98; i++) {
			String[] attr = {};
			attr = member[i].split(",");

			mem[i] = new Member(attr[0], attr[1], attr[2], Integer.parseInt(attr[3]), attr[4].charAt(0), attr[5]);
		}
		...
		System.out.println("=================================================================");
		for (Member m : mem) {
			System.out.println(m.getName() + "\t" + m.getJoinDate() + "\t" + m.getLastVisitDate() + "\t"
					+ m.getNumVisit() + "\t" + m.getGender() + "\t" + m.getAge());
		}
		System.out.println("=================================================================");
		...
		System.out.println("20대후반 여성의 총방문횟수 : " + cnt);
		...
		System.out.println("중장년층의 총 인원 수 : " + cnt2);
		System.out.println(cnt(mem));
	}
	
	public static int cnt(Member[] members) {
		
		int nine = 0;
		int eight = 0;
		
		for(Member m:members) {
			if(m.getJoinDate().contains("2019")) {
				nine++;
			} else if(m.getJoinDate().contains("2018")){
				eight++;
			} else {
				continue;
			}
