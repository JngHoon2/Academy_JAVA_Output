...
<div class="container">
	<div>
		<p>
		    <button type="button" class="btn btn-success" onclick="location.href='${pageContext.request.contextPath}/board/insertBoard'"><i class="fa fa-plus"></i> 게시물 등록</button>
		</p>
	</div>
