                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" 
                            ...
                            <div class="form-group">
                                ...
                                <span>
									<input type="text" name="user_id" id="id" class="form-control" required="required" autoFocus="autofocus" value="java">
                                </span>
                            ...
                            <div class="form-group">
                                ...
                                <span>
	                                <input type="password" name="user_pwd" id="pwd" class="form-control" required="required" value="1234">
                                </span>
                                <span class="error_next_box"></span>
