...
//	private IProductService productService;
	...
	//{
	//	log.info("여기는 ProductController 생성자에서 의존성 주입 체크합니다.");
	//	this.categoryService = categoryService;
	//	this.productService = productService;
	//}	
	
	// [3] 롬복의 @RequiredArgsConstructor + final 어노테이션과 생성자를 통한 의존성주입
	...
	public String insertProduct(@ModelAttribute Product product) 
	{
		...
		return "redirect:/product/product_list_datatable";
	}
	...
	@RequestMapping(value = "/product/product_delete", method = RequestMethod.POST)
